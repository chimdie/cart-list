		...
		<div className="relative overflow-hidden flex flex-col space-y-8">
			<div className="relative">
				...
				<div className="absolute flex items-center justify-center w-full -mt-6 z-10 transition-all">
					{productQuantity ? (
						<div className={`bg-[#c73a0f] justify-between text-white ${style}`}>
							<button
						...
						<button onClick={handleAddToCart} className={`space-x-1 ${style}`}>
							<AddToCartIcon />
							<span className="group-hover:text-cart-red font-medium">
								Add to card
							</span>
						</button>
					)}
			...
			<div className="flex flex-col space-y-">
				<span className="text-sm font-normal text-cart-rose-400">
					{product.category}
				</span>
				<span className="text-base font-semibold text-cart-rose-900">
					{product.name}
				</span>
